...
if __name__ == "__main__":
    ...
    best_model, train_losses, val_losses, test_losses, best_epoch = do_da_test("varberg", random_seed=42, subsample=0.05)
    
    torch.save(best_model.state_dict(), "Transfer Learning/trained_on_varnamo-finetuned_on_varberg.pth")
